...
EXPECTED: frozenset[tuple[str, str, str]] = frozenset(
    {
        ...
        ("list_templates", "mtui.commands.templates", "ListTemplates"),
        ...
        ("smelt_requests", "mtui.commands.smelt", "SmeltRequests"),
        ("smelt_update", "mtui.commands.smelt", "SmeltUpdate"),
        ("smelt_updates", "mtui.commands.smelt", "SmeltUpdates"),
        ("switch", "mtui.commands.switch", "Switch"),
        ...
        ("unload", "mtui.commands.unload", "Unload"),
