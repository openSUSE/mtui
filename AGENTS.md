...
```
Phased implementation plan lives in `PLAN-highlevel.md` + `PLAN-phase0..8.md`.
**Read the relevant `PLAN-phaseN.md` before working on a subsystem** — it records
the confirmed upstream behavior, the crate mapping, and the open decisions.
...
## Further reading
- `PLAN-highlevel.md` and `PLAN-phase0..8.md` — the implementation roadmap and the
  confirmed upstream behavior per subsystem.
